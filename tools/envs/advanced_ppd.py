...
class ProbabilisticPlanningDomainV1(gym.Env):
    def __init__(self):
        super().__init__()
        # Define the states and actions
        self.states = ['d1', 'd2', 'd3', 'd4', 'd5', 'd6']
        self.actions = ['m12', 'm14', 'm23', 'm34', 'm41', 'm54', 'm64']
        ...
        self._init_safe_policy = {'d1':'m14','d2':'m23','d3':'m34','d4':None,'d5':'m54', 'd6': 'm64'}

        self.transitions = {
            ('d1', 'm12'): [('d2', 1.0)],
            ('d1', 'm14'): [('d4', 0.05), ('d6', 0.95)],
